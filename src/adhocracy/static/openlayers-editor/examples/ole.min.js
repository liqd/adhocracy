...
*/
OpenLayers.Editor=OpenLayers.Class({map:null,id:null,editLayer:null,editorPanel:null,editMode:!1,dialog:null,showStatus:function(a,b){"error"===a&&alert(b)},activeControls:[],editorControls:"CleanFeature DeleteFeature Dialog DrawHole DrawPolygon DrawPath DrawPoint EditorPanel ImportFeature MergeFeature SnappingSettings SplitFeature CADTools TransformFeature".split(" "),featureTypes:["point","path","polygon"],sourceLayers:[],params:{},geoJSON:new OpenLayers.Format.GeoJSON,options:{},oleUrl:"",controls:{},
undoRedoActive:!0,initialize:function(a,b){OpenLayers.Util.extend(this,b);this.map=a instanceof OpenLayers.Map?a:new OpenLayers.Map;b||(b={});b.dialog||(this.dialog=new OpenLayers.Editor.Control.Dialog,this.map.addControl(this.dialog));this.id=OpenLayers.Util.createUniqueID("OpenLayers.Editor_");this.editLayer=b.editLayer?b.editLayer:new OpenLayers.Layer.Vector("Editor",{displayInLayerSwitcher:!1});b.styleMap||(this.editLayer.styleMap=new OpenLayers.StyleMap({"default":new OpenLayers.Style({fillColor:"#07f",
fillOpacity:0.8,strokeColor:"#037",strokeWidth:2,graphicZIndex:1,pointRadius:5}),select:new OpenLayers.Style({fillColor:"#fc0",strokeColor:"#f70",graphicZIndex:2}),temporary:new OpenLayers.Style({fillColor:"#fc0",fillOpacity:0.8,strokeColor:"#f70",strokeWidth:2,graphicZIndex:2,pointRadius:5})}));var c={editor:this,layer:this.editLayer,controls:["OpenLayers.Editor.Control.DeleteFeature","OpenLayers.Editor.Control.CleanFeature","OpenLayers.Editor.Control.MergeFeature","OpenLayers.Editor.Control.SplitFeature"]};
this.editLayer.events.register("featureselected",c,this.selectionChanged);this.editLayer.events.register("featureunselected",c,this.selectionChanged);for(var d=0,e=this.featureTypes.length;d<e;d++)"polygon"==this.featureTypes[d]?this.activeControls.push("DrawPolygon"):"path"==this.featureTypes[d]?this.activeControls.push("DrawPath"):"point"==this.featureTypes[d]&&this.activeControls.push("DrawPoint");d=0;for(e=this.sourceLayers.length;d<e;d++)c={editor:this,layer:this.sourceLayers[d],controls:["OpenLayers.Editor.Control.ImportFeature"]},
this.sourceLayers[d].events.register("featureselected",c,this.selectionChanged),this.sourceLayers[d].events.register("featureunselected",c,this.selectionChanged),this.sourceLayers[d].styleMap=new OpenLayers.StyleMap({"default":new OpenLayers.Style({fillColor:"#0c0",fillOpacity:0.8,strokeColor:"#070",strokeWidth:2,graphicZIndex:1,pointRadius:5}),select:new OpenLayers.Style({fillColor:"#fc0",strokeColor:"#f70",graphicZIndex:2}),temporary:new OpenLayers.Style({fillColor:"#fc0",fillOpacity:0.8,strokeColor:"#f70",
strokeWidth:2,graphicZIndex:2,pointRadius:5})}),this.map.addLayer(this.sourceLayers[d]);this.map.editor=this;this.map.addLayer(this.editLayer);this.map.addControl(new OpenLayers.Editor.Control.LayerSettings(this));this.undoRedoActive&&this.map.addControl(new OpenLayers.Editor.Control.UndoRedo(this.editLayer));this.addEditorControls();return this},selectionChanged:function(){var a=this.editor.editorPanel.getControlsByClass("OpenLayers.Control.SelectFeature")[0];if(0<this.layer.selectedFeatures.length&&
a&&a.active)for(var a=0,b=this.controls.length;a<b;a++){var c=this.editor.editorPanel.getControlsByClass(this.controls[a])[0];c&&OpenLayers.Element.removeClass(c.panel_div,"oleControlDisabled")}else{a=0;for(b=this.controls.length;a<b;a++)(c=this.editor.editorPanel.getControlsByClass(this.controls[a])[0])&&OpenLayers.Element.addClass(c.panel_div,"oleControlDisabled")}this.editor.editorPanel.redraw()},startEditMode:function(){this.editMode=!0;this.editorPanel.activate()},stopEditMode:function(){this.editMode=
!1;this.editorPanel.deactivate()},addEditorControls:function(){for(var a=null,b=[],c=0,d=this.activeControls.length;c<d;c++){a=this.activeControls[c];-1<OpenLayers.Util.indexOf(this.editorControls,a)&&b.push(new OpenLayers.Editor.Control[a](this.editLayer,this.options[a]));switch(a){case "Separator":b.push(new OpenLayers.Control.Button({displayClass:"olControlSeparator"}));break;case "Navigation":b.push(new OpenLayers.Control.Navigation(OpenLayers.Util.extend({title:OpenLayers.i18n("oleNavigation")},
this.options.Navigation)));break;case "DragFeature":b.push(new OpenLayers.Editor.Control.DragFeature(this.editLayer,OpenLayers.Util.extend({},this.options.DragFeature)));break;case "ModifyFeature":b.push(new OpenLayers.Control.ModifyFeature(this.editLayer,OpenLayers.Util.extend({title:OpenLayers.i18n("oleModifyFeature")},this.options.ModifyFeature)));break;case "SelectFeature":b.push(new OpenLayers.Control.SelectFeature(this.sourceLayers.concat([this.editLayer]),OpenLayers.Util.extend({title:OpenLayers.i18n("oleSelectFeature"),
clickout:!0,toggle:!1,multiple:!1,hover:!1,toggleKey:"ctrlKey",multipleKey:"ctrlKey",box:!0},this.options.SelectFeature)))}this.controls[a]=b[b.length-1]}this.editorPanel=this.createEditorPanel(b);this.map.addControl(this.editorPanel)},addEditorControl:function(a){this.controls[a.CLASS_NAME]=a;this.editorPanel.addControls([a]);this.map.addControl(a)},createEditorPanel:function(a){var b=new OpenLayers.Editor.Control.EditorPanel(this);b.addControls(a);return b},status:function(a){"error"==a.type&&alert(a.content)},
loadFeatures:function(a){this.editLayer.destroyFeatures();a&&(this.editLayer.addFeatures(a),this.map.zoomToExtent(this.editLayer.getDataExtent()))},requestComplete:function(a){a=(new OpenLayers.Format.JSON).read(a.responseText);this.map.editor.stopWaiting();a?a.error?this.showStatus("error",a.message):(a.params&&OpenLayers.Util.extend(this.params,a.params),a.geo&&(a=this.geoJSON.read(a.geo),this.editLayer.removeFeatures(this.editLayer.selectedFeatures),this.editLayer.addFeatures(this.toFeatures(a)),
...
"olEditorWaiting");OpenLayers.Element.removeClass(this.map.div,"olEditorWaiting")},CLASS_NAME:"OpenLayers.Editor"});OpenLayers.Editor.Control=OpenLayers.Class(OpenLayers.Control,{initialize:function(a){OpenLayers.Control.prototype.initialize.apply(this,[a])},CLASS_NAME:"OpenLayers.Editor.Control"});OpenLayers.Editor.VERSION_NUMBER="1.0-beta1";/*
    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
*/
...
"oleDialogToolbar"):OpenLayers.Element.addClass(this.div,"oleFadeMap");a.title&&(b=document.createElement("h3"),b.innerHTML=a.title,this.dialogDiv.appendChild(b));"string"===typeof a.content?(b=document.createElement("div"),b.innerHTML=a.content,this.dialogDiv.appendChild(b)):OpenLayers.Util.isElement(a.content)&&this.dialogDiv.appendChild(a.content);a.save?(b=this.getButton("cancelButton","cancel","oleDialogCancelButton"),this.dialogDiv.appendChild(b),c=this.getButton("saveButton","save","oleDialogSaveButton"),
this.dialogDiv.appendChild(c),OpenLayers.Event.observe(b,"click",this.hide.bind(this)),OpenLayers.Event.observe(c,"click",this.hide.bind(this)),OpenLayers.Event.observe(c,"click",a.save.bind(this)),a.cancel&&OpenLayers.Event.observe(b,"click",a.cancel.bind(this))):a.toolbox||(b=this.getButton("okButton","save","oleDialogOkButton"),this.dialogDiv.appendChild(b),a.close&&OpenLayers.Event.observe(b,"click",a.close),OpenLayers.Event.observe(b,"click",OpenLayers.Function.bind(this.hide,this)));a=this.dialogDiv.getElementsByTagName("input");
for(b=0;b<a.length;b++)"text"==a[b].getAttribute("type")&&OpenLayers.Element.addClass(a[b],this.inputTextClass);this.map.viewPortDiv.appendChild(this.dialogDiv);OpenLayers.Event.observe(this.div,"click",this.ignoreEvent);OpenLayers.Event.observe(this.div,"mousedown",this.ignoreEvent);OpenLayers.Event.observe(this.div,"dblclick",this.ignoreEvent);OpenLayers.Event.observe(this.dialogDiv,"mousedown",this.ignoreEvent);OpenLayers.Event.observe(this.dialogDiv,"dblclick",this.ignoreEvent)},hide:function(){this.map.viewPortDiv.removeChild(this.dialogDiv);
OpenLayers.Element.removeClass(this.div,"oleFadeMap")},ignoreEvent:function(a){OpenLayers.Event.stop(a,!0)},getButton:function(a,b,c){var d=document.createElement("input");d.id=a;d.name=b;d.value=OpenLayers.i18n(c);d.type="button";OpenLayers.Element.addClass(d,this.buttonClass);return d},CLASS_NAME:"OpenLayers.Editor.Control.Dialog"});/*
    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
*/
...
if(!1!==this.layer.events.triggerEvent("sketchcomplete",{feature:b})&&a.getArea()>=this.minArea){var b=a.getVertices(),c,d=0,e=this.layer.features.length;a:for(;d<e;d++){var f=this.layer.features[d];c=!0;for(var i=0,h=b.length;i<h;i++)f.geometry.intersects(b[i])||(c=!1);if(c){f.state=OpenLayers.State.UPDATE;this.layer.events.triggerEvent("beforefeaturemodified",{feature:f});f.geometry.components.push(a.components[0]);this.layer.drawFeature(f);this.layer.events.triggerEvent("featuremodified",{feature:f});
...
{feature:b})&&a.getLength()>=this.minLength&&(b.state=OpenLayers.State.INSERT,this.layer.addFeatures([b]),this.featureAdded(b),this.events.triggerEvent("featureadded",{feature:b}))},CLASS_NAME:"OpenLayers.Editor.Control.DrawPath"});/*
 ...
 @link       https://github.com/geops/ole
*/
OpenLayers.Editor.Control.DrawPoint=OpenLayers.Class(OpenLayers.Control.DrawFeature,{title:OpenLayers.i18n("oleDrawPoint"),initialize:function(a,b){this.callbacks=OpenLayers.Util.extend(this.callbacks,{point:function(a){this.layer.events.triggerEvent("pointadded",{point:a})}});OpenLayers.Control.DrawFeature.prototype.initialize.apply(this,[a,OpenLayers.Handler.Point,b]);this.title=OpenLayers.i18n("oleDrawPoint")},drawFeature:function(a){a=new OpenLayers.Feature.Vector(a);!1!==this.layer.events.triggerEvent("sketchcomplete",
{feature:a})&&(a.state=OpenLayers.State.INSERT,this.layer.addFeatures([a]),this.featureAdded(a),this.events.triggerEvent("featureadded",{feature:a}))},CLASS_NAME:"OpenLayers.Editor.Control.DrawPoint"});/*
    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
*/
...
if(null===this.feature||this.feature.geometry instanceof OpenLayers.Geometry.Point){this.editLayer.drawFeature(this.box,this.renderIntent);var b,c;for(c=0;c<this.rotationHandles.length;c++)b=this.rotationHandles[c],this.editLayer.drawFeature(b,this.renderIntent);for(c=0;c<this.handles.length;c++)b=this.handles[c],this.editLayer.drawFeature(b,this.renderIntent)}this.events.on({setfeature:this.highlightTransformedFeature,scope:this});return a},deactivate:function(){for(var a=0;a<this.strategiesOnHold.length;a++)this.strategiesOnHold[a].activate();
a=OpenLayers.Control.TransformFeature.prototype.deactivate.apply(this,arguments);this.unsetFeature();this.events.un({setfeature:this.highlightTransformedFeature,scope:this});this.drawOriginalsFeature&&(this.layer.drawFeature(this.drawOriginalsFeature,this.drawOriginalsRenderIntent),this.drawOriginalsRenderIntent=this.drawOriginalsFeature=null);return a},highlightTransformedFeature:function(a){this.drawOriginalsFeature&&this.layer.drawFeature(this.drawOriginalsFeature,this.drawOriginalsRenderIntent);
this.drawOriginalsFeature=a.feature;this.drawOriginalsRenderIntent=a.feature.renderIntent;this.layer.drawFeature(a.feature,"select")},createBox:function(){var a=this;this.center=new OpenLayers.Geometry.Point(0,0);this.box=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.LineString([new OpenLayers.Geometry.Point(-1,-1),new OpenLayers.Geometry.Point(0,-1),new OpenLayers.Geometry.Point(1,-1),new OpenLayers.Geometry.Point(1,0),new OpenLayers.Geometry.Point(1,1),new OpenLayers.Geometry.Point(0,1),
new OpenLayers.Geometry.Point(-1,1),new OpenLayers.Geometry.Point(-1,0),new OpenLayers.Geometry.Point(-1,-1)]),null,"string"==typeof this.renderIntent?null:this.renderIntent);this.box.geometry.move=function(b,c){a._moving=!0;OpenLayers.Geometry.LineString.prototype.move.apply(this,arguments);a.center.move(b,c);delete a._moving};for(var b=function(a,b){OpenLayers.Geometry.Point.prototype.move.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.move(a,b);this._handle.geometry.move(a,
b)},c=function(a,b,c){OpenLayers.Geometry.Point.prototype.resize.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.resize(a,b,c);this._handle.geometry.resize(a,b,c)},d=function(a,b){OpenLayers.Geometry.Point.prototype.rotate.apply(this,arguments);this._rotationHandle&&this._rotationHandle.geometry.rotate(a,b);this._handle.geometry.rotate(a,b)},e=function(b,c){var d=this.x,e=this.y;OpenLayers.Geometry.Point.prototype.move.call(this,b,c);if(!a._moving){var f=a.dragControl.handlers.drag.evt,
i=!(!a._setfeature&&a.preserveAspectRatio)&&!(f&&f.shiftKey),h=new OpenLayers.Geometry.Point(d,e),f=a.center;this.rotate(-a.rotation,f);h.rotate(-a.rotation,f);var k=this.x-f.x,g=this.y-f.y,j=k-(this.x-h.x),l=g-(this.y-h.y);a.irregular&&!a._setfeature&&(k-=(this.x-h.x)/2,g-=(this.y-h.y)/2);this.x=d;this.y=e;h=1;a.feature.geometry instanceof OpenLayers.Geometry.Point?g=1:i?(g=1E-5>Math.abs(l)?1:g/l,h=(1E-5>Math.abs(j)?1:k/j)/g):(j=Math.sqrt(j*j+l*l),g=Math.sqrt(k*k+g*g)/j);a._moving=!0;a.box.geometry.rotate(-a.rotation,
f);delete a._moving;a.box.geometry.resize(g,f,h);a.box.geometry.rotate(a.rotation,f);a.transformFeature({scale:g,ratio:h});a.irregular&&!a._setfeature&&(k=f.clone(),k.x+=1E-5>Math.abs(d-f.x)?0:this.x-d,k.y+=1E-5>Math.abs(e-f.y)?0:this.y-e,a.box.geometry.move(this.x-d,this.y-e),a.transformFeature({center:k}))}},f=function(b,c){var d=this.x,e=this.y;OpenLayers.Geometry.Point.prototype.move.call(this,b,c);if(!a._moving){var f=a.dragControl.handlers.drag.evt,f=f&&f.shiftKey?45:1,h=a.center,g=this.x-h.x,
i=this.y-h.y;this.x=d;this.y=e;d=Math.atan2(i-c,g-b);d=Math.atan2(i,g)-d;d*=180/Math.PI;a._angle=(a._angle+d)%360;d=a.rotation%f;if(Math.abs(a._angle)>=f||0!==d)d=Math.round(a._angle/f)*f-d,a._angle=0,a.box.geometry.rotate(d,h),a.transformFeature({rotation:d})}},i=Array(8),h=Array(4),g,l,m,n="sw s se e ne n nw w".split(" "),j=0;8>j;++j)g=this.box.geometry.components[j],l=new OpenLayers.Feature.Vector(g.clone(),{role:n[j]+"-resize"},"string"==typeof this.renderIntent?null:this.renderIntent),0==j%2&&
(m=new OpenLayers.Feature.Vector(g.clone(),{role:n[j]+"-rotate"},"string"==typeof this.rotationHandleSymbolizer?null:this.rotationHandleSymbolizer),m.geometry.move=f,g._rotationHandle=m,h[j/2]=m),g.move=b,g.resize=c,g.rotate=d,l.geometry.move=e,g._handle=l,i[j]=l;this.rotationHandles=h;this.handles=i}});OpenLayers.Editor.Control.FixedAngleDrawing=OpenLayers.Class(OpenLayers.Control,{CLASS_NAME:"OpenLayers.Editor.Control.FixedAngleDrawing",active:!1,sketchVerticesAmount:null,guides:null,initialize:function(a){this.guides=[];OpenLayers.Control.prototype.initialize.call(this);this.layer=a},activate:function(){var a=OpenLayers.Control.prototype.activate.call(this);if(a)this.layer.events.on({sketchstarted:this.onSketchStarted,sketchmodified:this.onSketchModified,sketchcomplete:this.onSketchComplete,scope:this});
...
f.b,d),f=this.createWorldBoundaryPoint(f.m,d.right,f.b,d));d=a.geometry.components[0];d.x=c.x;d.y=c.y;var i=a.geometry.components[1];i.x=f.x;i.y=f.y;c=OpenLayers.Layer.Vector.prototype.drawFeature.apply(this,arguments);d.x=e.x1;d.y=e.y1;i.x=e.x2;i.y=e.y2}else console.warn("Failed to render a feature",a)}return c},moveTo:function(a,b,c){OpenLayers.Layer.Vector.prototype.moveTo.apply(this,arguments);this.features.forEach(function(a){this.drawFeature(a)},this)}});/*
    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
*/
...
this,this.onDeactivate);this.title=OpenLayers.i18n("oleSnappingSettings")},onDeactivate:function(){this.snapping.active&&this.activate()},openSnappingDialog:function(){var a,b;this.activate();this.layerListDiv=document.createElement("div");a=document.createElement("div");b=document.createElement("h4");b.innerHTML=OpenLayers.i18n("oleSnappingSettingsTolerance");a.appendChild(b);this.toleranceInput=document.createElement("input");this.toleranceInput.type="text";this.toleranceInput.size=4;this.toleranceInput.value=
this.tolerance;a.appendChild(this.toleranceInput);b=document.createElement("h4");b.innerHTML=OpenLayers.i18n("oleSnappingSettingsLayer");a.appendChild(b);a.appendChild(this.layerListDiv);this.map.editor.dialog.show({content:a,title:OpenLayers.i18n("oleSnappingSettings"),close:OpenLayers.Function.bind(this.changeSnapping,this)});this.redraw()},redraw:function(){var a,b,c;this.layerListDiv.innerHTML="";for(var d=0;d<this.map.layers.length;d++)a=this.map.layers[d],!(a instanceof OpenLayers.Layer.Vector.RootContainer)&&
(a instanceof OpenLayers.Layer.Vector&&!(a instanceof OpenLayers.Editor.Layer.Snapping)&&-1==a.name.search(/OpenLayers.Handler.+/))&&(c=document.createElement("div"),b=document.createElement("input"),b.type="checkbox",b.name="snappingLayer",b.id="Snapping."+a.id,b.value="true",0<=this.snappingLayers.indexOf(a)&&(b.checked="checked",b.defaultChecked="selected"),c.appendChild(b),OpenLayers.Event.observe(b,"click",OpenLayers.Function.bind(this.setLayerSnapping,this,a,b.checked)),b=document.createElement("label"),
b.setAttribute("for","Snapping."+a.id),b.innerHTML=a.name,OpenLayers.Event.observe(b,"click",OpenLayers.Function.bind(function(a){OpenLayers.Event.stop(a,true)},this)),c.appendChild(b),this.layerListDiv.appendChild(c))},setLayerSnapping:function(a,b){b?this.snappingLayers.splice(this.snappingLayers.indexOf(a),1):this.snappingLayers.push(a);this.redraw()},changeSnapping:function(){this.tolerance=parseInt(this.toleranceInput.value,10);if(0<this.snappingLayers.length){this.snapping.deactivate();for(var a=
[],b=0;b<this.snappingLayers.length;b++)a.push({layer:this.snappingLayers[b],tolerance:this.tolerance});this.snapping=new OpenLayers.Control.Snapping({layer:this.layer,targets:a});for(b=0;b<a.length;b++)a[b].layer.moveTo(this.map.getExtent(),!1,!1);this.snapping.activate()}else this.snapping.active&&(this.snapping.deactivate(),this.snapping.targets=null);this.snapping.active||this.deactivate()},setMap:function(a){OpenLayers.Control.Button.prototype.setMap.apply(this,arguments);null===this.snappingGuideLayer&&
(this.snappingGuideLayer=this.createSnappingGuideLayer())},createSnappingGuideLayer:function(){var a=new OpenLayers.Editor.Layer.Snapping(OpenLayers.i18n("Snapping Layer"),{visibility:!1});this.map.addLayer(a);return a},CLASS_NAME:"OpenLayers.Editor.Control.SnappingSettings"});/*
    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
*/
...
new OpenLayers.Feature.Vector(a),b=new OpenLayers.Format.WKT,c=this.layer.events.triggerEvent("sketchcomplete",{feature:a});this.deactivate();!1!==c&&0<this.layer.selectedFeatures.length&&(c=b.write(this.layer.selectedFeatures),a=b.write(a),this.map.editor.startWaiting(this.panel_div),OpenLayers.Request.POST({url:this.map.editor.oleUrl+"process/split",data:OpenLayers.Util.getParameterString({cut:a,geo:c}),headers:{"Content-Type":"application/x-www-form-urlencoded"},callback:this.map.editor.requestComplete,
...
oleLayerSettingsImportHeader:"Importar",oleLayerSettingsImportLabel:"Fer servir com a capa origen",oleLayerSettingsLegendHeader:"Llegenda",oleLayerSettingsOpacityHeader:"Opacitat (%)",oleMergeFeature:"Barrejar les geometries seleccionades",oleMergeFeatureSelectFeature:"Si us plau seleccioneu com a mínim 2 geometries.",oleModifyFeature:"Modificar geometria",oleNavigation:"Navegació",oleSelectFeature:"Seleccionar geometria",oleSnappingSettings:"Configuració de l'ajust automàtic",oleSnappingSettingsLayer:"Capa d'ajust automàtic",
...
oleLayerSettingsImportHeader:"Import",oleLayerSettingsImportLabel:"Layer als Quelle für Import verwenden",oleLayerSettingsLegendHeader:"Legende",oleLayerSettingsOpacityHeader:"Opazität in %",oleMergeFeature:"Selektierte Geometrien verschmelzen",oleMergeFeatureSelectFeature:"Bitte mindestens 2 Flächen auswählen.",oleModifyFeature:"Geometrien bearbeiten",oleNavigation:"Navigation",oleSelectFeature:"Geometrien selektieren",oleSnappingSettings:"Snapping Einstellungen",oleSnappingSettingsLayer:"Snapping Layer",
oleSnappingSettingsTolerance:"Snapping Toleranz in px",oleSplitFeature:"Selektierte Geometrien teilen",oleTransformFeature:"Geometrie skalieren, drehen und verschieben",oleCADTools:"CAD Funktionen",oleCADToolsDialogParallelDrawing:"Paralleles Zeichnen aktivieren",oleCADToolsDialogGuidedDrawing:"Geführtes Zeichnen aktivieren",oleCADToolsDialogShowLayer:"Hilfslinien anzeigen",oleCADToolsDialogTolerance:"px Toleranz"});OpenLayers.Lang.en=OpenLayers.Util.extend(OpenLayers.Lang.en,{oleCleanFeature:"Clean selected geometry",oleDeleteFeature:"Delete selected geometry",oleDragFeature:"Drag geometry",oleDrawHole:"Draw hole",oleDrawPolygon:"Draw polygon",oleDrawPath:"Draw path",oleDrawPoint:"Draw point",oleImportFeature:"Import selected geometry",oleImportFeatureSourceLayer:"Found no source layer.",oleImportFeatureSourceFeature:"Please select a geometry first.",oleLayerSettingsImportHeader:"Import",oleLayerSettingsImportLabel:"Use as source layer",
oleLayerSettingsLegendHeader:"Legend",oleLayerSettingsOpacityHeader:"Opacity (%)",oleMergeFeature:"Merge selected geometry",oleMergeFeatureSelectFeature:"Please select at least 2 geometries.",oleModifyFeature:"Modify geometry",oleNavigation:"Navigation",oleSelectFeature:"Select geometry",oleSnappingSettings:"Snapping settings",oleSnappingSettingsLayer:"Snapping layer",oleSnappingSettingsTolerance:"Snapping tolerance",oleSplitFeature:"Split selected geometry",oleTransformFeature:"Scale, rotate and move geometry",
oleCADTools:"CAD Tools",oleCADToolsDialogParallelDrawing:"Parallel Drawing",oleCADToolsDialogGuidedDrawing:"Guided Drawing",oleCADToolsDialogShowLayer:"Show Guide Lines",oleCADToolsDialogTolerance:"px tolerance"});
