(function(b){b.fn.selectHierarchy=function(f){for(var f=b.extend({separator:" > ",hideOriginal:!0,placeholder:"------",include_empty_options:!0,add_empty_default:!1},f),g=b(this),k=1,l=g.find("option").map(function(){var a=b(this).val();if(f.include_empty_options||a){var d=b(this).text(),c=d.split(f.separator),e=c.length;e>k&&(k=e);return{label:d,short_label:c[e-1],value:a,depth:e,children:[],header:b(this).data("header")}}}),m=[],i=1;i<=k;i++)b.each(l,function(){var a=this;a.depth==i&&(1===i&&m.push(this),
b.each(l,function(){this.depth==i+1&&this.label.match("^"+a.label)==a.label&&a.children.push(this)}))});var j=g.children("option:selected").text();f.hideOriginal&&g.hide();g.wrap('<span class="drilldown-wrapper" />');var h=b("<select>").addClass("drilldown-1");g.after(h);f.add_empty_default&&h.add('<option value="">'+f.placeholder+"</option>");h.data("depth",1);b.each(m,function(){var a=b("<option>");a.val(this.value);a.text(this.short_label);a.data("node",this);h.append(a)});var n=function(){var a=
