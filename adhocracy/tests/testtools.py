...
def tt_make_proposal(creator=None, voting=False, title=None, description=None,
                     wiki=False):
    ...
    description = description if description else tt_make_str()
    proposal = model.Proposal.create(instance, title, creator, description,
                                     wiki=wiki)
