...
def make_map():
    ...
    map.connect('/user/{id}/motions', controller='user', action='motions')
    ...
    map.connect('/motion/{id}/end_poll', controller='motion', action='end_poll')
    ...
    map.connect('/instance/logo/{key}.png', controller='instance', action='logo')
