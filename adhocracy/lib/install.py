...
def setup_entities():
    ...
    mk_perm("category.create", observer)
    mk_perm("category.edit", observer)
    mk_perm("category.delete", observer)
    mk_perm("category.view", anonymous)
    mk_perm("comment.view", anonymous)
    mk_perm("comment.create", observer)
    mk_perm("comment.edit", observer)
    mk_perm("comment.delete", observer)
    mk_perm("karma.give", observer)
    mk_perm("motion.create", observer)
    mk_perm("motion.edit", observer)
    mk_perm("motion.delete", observer)
    mk_perm("motion.view", anonymous)
    mk_perm("poll.create", observer)
    mk_perm("poll.abort", observer)
    mk_perm("issue.create", observer)
    mk_perm("issue.edit", observer)
    mk_perm("issue.delete", observer)
